    ...
    <div class="header_content d-flex flex-row align-items-center">
      ...
      <nav class="main_nav_container">
        <div class="main_nav">
          ...
          <li class="main_nav_item"><a href="#">Category</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 hero_box_col">
            <div class="hero_box d-flex flex-row align-items-center justify-content-start">
              <img src="{{asset('user/images/earth-globe.svg')}}" class="svg" alt="">
          ...
          <div class="col-lg-4 hero_box_col">
            <div class="hero_box d-flex flex-row align-items-center justify-content-start">
              <img src="{{asset('user/images/books.svg')}}" class="svg" alt="">
              <div class="hero_box_content">
            ...
            <div class="row d-flex flex-row align-items-end">
              ...
              <div class="col-lg-4 order-lg-3 order-1">
                <div class="event_image">
                  <img src="{{asset('úser/images/event_1.jpg')}}" alt="https://unsplash.com/@theunsteady5">
                </div>
              </div>
        ...
        <div class="row event_item">
          <div class="col">
            <div class="row d-flex flex-row align-items-end">
              ...
              <div class="col-lg-4 order-lg-3 order-1">
                <div class="event_image">
                  <img src="{{asset('user/images/event_2.jpg')}}" alt="https://unsplash.com/@claybanks1989">
                </div>
              </div>
        ...
        <div class="row event_item">
          <div class="col">
            <div class="row d-flex flex-row align-items-end">
              ...
              <div class="col-lg-4 order-lg-3 order-1">
                <div class="event_image">
                  <img src="{{asset('user/images/event_3.jpg')}}" alt="https://unsplash.com/@juanmramosjr">
                </div>
              </div>
